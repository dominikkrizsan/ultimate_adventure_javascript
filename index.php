  ...
  <div class="login-container-background">
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
      <div class="login-main-container">
        ...
        ?>
        <img src="./imgs/asd.jpg" alt="login-logo">
        <div class="login-content">
          <label class="login-label" for="userlogin">Login to your account</label>
          ...
          <a class="login-create-account" href="register.php">Create your Account</a>
        </div>
      </div>
    </form>
  </div>
